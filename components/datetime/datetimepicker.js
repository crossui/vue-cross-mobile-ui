...
const TEMPLATE = `<div class="dp-container">
  <div class="dp-header">
    <div class="dp-item dp-left vcu-datetime-cancel" data-role="cancel">cancel</div>
    <div class="dp-item vcu-datetime-clear" data-role="clear"></div>
    <div class="dp-item dp-right vcu-datetime-confirm" data-role="confirm">done</div>
  </div>
...
DatetimePicker.prototype = {
    ...
    _show(newValueMap) {
        ...
        if (this.renderInline) {
            self.container.classList.add('vcu-datetime-view')
        }
    ...
    show(value) {
        ...
        if (config.isOneInstance) {
            if (document.querySelector('#vcu-datetime-instance')) {
                return
            }
            self.willShow = true
        }
        ...
        if (self.container) {
            ...
            if (config.isOneInstance) {
                container.id = 'vcu-datetime-instance'
            }
