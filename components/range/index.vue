<template>
  <div class="vcu-range-input-box" style="position:relative;margin-right:30px;margin-left:50px;">
    <input class="vcu-range-input" v-model.number="currentValue">
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      ...
      this.range = new Powerange(this.$el.querySelector('.vcu-range-input'), options)
