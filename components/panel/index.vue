<template>
  <div class="vcu-panel vcu-panel_access">
      ...
      <slot name="body">
        ...
        <template v-if="type === '1'">
          <a
            ...
            class="vcu-media-box vcu-media-box_appmsg"
          >
            <div class="vcu-media-box__hd" v-if="item.src">
              <img
                class="vcu-media-box__thumb"
                :src="item.src"
        ...
        <template v-if="type === '2'">
          <div
            class="vcu-media-box vcu-media-box_text"
            v-for="(item, index) in list"
            @click.prevent="onItemClick(item)"
            :key="index"
          >
        ...
        <template v-if="type === '4'">
          ...
          >
            ...
            <ul class="vcu-media-box__info" v-if="item.meta">
              <li
                class="vcu-media-box__info__meta"
              ...
              ></li>
              <li
                class="vcu-media-box__info__meta vcu-media-box__info__meta_extra"
    ...
    <div class="vcu-panel__ft">
      <a
        class="vcu-cell vcu-cell_access vcu-cell_link"
