<template>
  <div class="vcu-cell">
    ...
    <div class="vcu-cell__ft vcu-cell-primary" :class="{'vcu-number-round': buttonStyle === 'round'}" v-show="!readonly" style="font-size:0">
      <div :style="{float:align}">
        <a @click="sub" class="vcu-number-selector vcu-number-selector-sub" :class="{'vcu-number-disabled':disabledMin}">
        ...
        <input v-model.number="currentValue" :name="name" class="vcu-number-input" :style="{width: width}" :readonly="!fillable" pattern="[0-9]*" type="number" @blur="blur" />
        <a @click="add" class="vcu-number-selector vcu-number-selector-plus" :class="{'vcu-number-disabled':disabledMax}">
    ...
    <div class="vcu-cell__ft vcu-cell-primary" v-show="readonly">
      {{value}}
    </div>
  </div>
</template>
