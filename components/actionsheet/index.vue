<template>
  <div class="vcu-actionsheet-wrap">
    <transition name="vcu-actionsheet-mask">
      <div
        class="vcu-mask vcu-mask_transparent"
    ...
    <div
      class="vcu-actionsheet"
      :class="{ 'vcu-actionsheet_toggle': show }"
      v-else
      ref="iOSMenu"
    >
      <div class="vcu-actionsheet__menu">
        ...
        <div
          ...
          @click="onMenuClick(text, key)"
          v-html="text.label || text"
          :class="`vcu-actionsheet-menu-${text.type || 'default'}`"
          :key="key"
        ></div>
      </div>
      <div
        class="vcu-actionsheet__action"
