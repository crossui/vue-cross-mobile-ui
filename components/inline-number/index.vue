<template>
  <div
    :class="{ 'vcu-number-round': buttonStyle === 'round' }"
    class="vcu-inline-number"
  >
    <div>
      <a
        @click="sub"
        class="vcu-number-selector vcu-number-selector-sub"
        :class="{ 'vcu-number-disabled': disabledMin }"
      >
        <svg
      ...
      <a
        @click="add"
        class="vcu-number-selector vcu-number-selector-plus"
        :class="{ 'vcu-number-disabled': disabledMax }"
      >
        <svg
          viewBox="0 0 1024 1024"
          version="1.1"
