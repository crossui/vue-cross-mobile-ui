<template>
  <div class="vcu-swipeout-item" @touchstart="start" @mousedown="start" @touchmove="move" @mousemove="move" @touchend="end" @mouseup="end" @touchcancel="end">
    <div class="vcu-swipeout-button-box vcu-swipeout-button-box-left" :style="leftButtonBoxStyle" v-show="distX >= 0">
      <slot name="left-menu"></slot>
    </div>
    <div class="vcu-swipeout-button-box" :style="rightButtonBoxStyle" v-show="distX <= 0">
      <slot name="right-menu"></slot>
    </div>
    <div class="vcu-swipeout-content" :style="styles" @mousedown="onContentClick" @touchstart="onContentClick" ref="content">
  ...
  methods: {
    ...
    setOffset(x, animated = false, force) {
      ...
      if (animated && this.target) {
        this.target && this.target.classList.add('vcu-swipeout-content-animated')
        var cb = (function (self, target) {
          return function () {
            target.classList.remove('vcu-swipeout-content-animated')
